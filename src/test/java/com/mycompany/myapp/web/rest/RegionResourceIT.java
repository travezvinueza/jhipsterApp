...
class RegionResourceIT {
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().nombreRegion(DEFAULT_NOMBRE_REGION);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().nombreRegion(UPDATED_NOMBRE_REGION);
        return region;
    }
    ...
    void getRegion() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.nombreRegion").value(DEFAULT_NOMBRE_REGION));
    }
    ...
    void putExistingRegion() throws Exception {
        ...
        updatedRegion.nombreRegion(UPDATED_NOMBRE_REGION);
    ...
    void partialUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.nombreRegion(UPDATED_NOMBRE_REGION);
