...
describe('Trabajo Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'trabajo', component: TrabajoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trabajos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to trabajoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTrabajoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTrabajoIdentifier).toHaveBeenCalledWith(entity);
